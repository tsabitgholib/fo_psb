<div class="fixed bottom-0 sm:max-w-md w-full">
    <div class="w-full flex justify-between">
        <!-- Card 1 -->
        <a href="/pendaftaran" class="bg-gray-50 z-40 w-5/12 rounded-tr-3xl border-t-2 p-4 flex flex-col items-center rounded-xl">
            <div
        ...
        <!-- Card 2 -->
        <a href="https://wa.me/6289667011213" class="bg-gray-50 z-40 w-5/12 rounded-tl-3xl p-4 border-t-2 flex flex-col items-center rounded-xl">
            <div
                class="transition text-gray-600 hover:text-blue-900 active:-translate-y-1 active:underline underline-offset-4 flex flex-col items-center">
    ...
    <!-- Background Shape -->
    <div class="w-full h-20 rounded-t-[200%] absolute bottom-0 border-t-2 bg-gray-50 z-20"></div>
</div>
